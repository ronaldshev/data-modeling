...
CREATE TABLE `connected_to` (
  ...
  FOREIGN KEY (`continent1`) REFERENCES `continent` (`Name`),
  FOREIGN KEY (`continent2`) REFERENCES `continent` (`Name`)
);
...
CREATE TABLE `continent` (
  ...
  `Area` int(11) DEFAULT NULL,
  PRIMARY KEY (`Name`),
FOREIGN KEY (`Name`) REFERENCES `landmass` (`Name`)
);
...
CREATE TABLE `located_in` (
  ...
  FOREIGN KEY (`ocean`) REFERENCES `ocean` (`name`)
);
